...
import { Upload, Loader2, CheckCircle, XCircle, Youtube, ChevronDown, ChevronUp, RefreshCw } from 'lucide-react';
  ...
  return (
    <div className="min-h-screen bg-gradient-to-br from-blue-50 via-purple-50 to-pink-50 py-8 px-4">
      <div className="max-w-2xl mx-auto">
        ...
        {/* Job Status */}
        {currentJob && (
          <div className={`bg-white rounded-2xl shadow-xl p-6 mb-6 border-l-4 ${
